    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{ route('category.list') }}" class="pc-link">
                        <span class="pc-micon">
                ...
                <li class="pc-item">
                    <a href="{{ route('expense.list') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="ph-duotone ph-projector-screen-chart"></i>
                        </span>
                        <span class="pc-mtext">Expense List</span>
                    </a>
                </li>

                <li class="pc-item">
                    <a href="{{ route('expense.current_month_report') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="ph-duotone ph-projector-screen-chart"></i>
                        </span>
                        <span class="pc-mtext">Expense Monthly Report</span>
                    </a>
                </li>

                  <li class="pc-item">
                    <a href="{{ route('expense.current_month_report_graph') }}" class="pc-link">
                        <span class="pc-micon">
                            <i class="ph-duotone ph-projector-screen-chart"></i>
                        </span>
                        <span class="pc-mtext">Current Month Pie chart</span>
                    </a>
                </li>
